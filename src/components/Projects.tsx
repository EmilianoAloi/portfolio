...
import linLogo from "../../public/logo-sin-fondo.png";
import linguaFrame from "../../public/screenProjects/FrameLingua.png";
import mobileLi from "../../public/screenProjects/mobileLI.png";
  ...
  return (
    ...
    >
      ...
      <motion.div className="grid grid-cols-1 grid-rows-5 gap-8 w-full">
        <Link
          target="_blank"
          href="https://lingua-escobar.vercel.app/"
          ...
          >
            <div className="flex flex-col justify-center lg:w-3/5 p-5 ">
              <Image
                ...
                width={100}
                height={150}
                alt="compleet labs Logo"
                className="mb-4 z-10 "
              />
              <h3 className="text-lg font-semibold ">
                Lingua - (En construcción)
              </h3>
              <h4 className="text-sm text-zinc-500 mb-2">
                Desarrollo Frontend
              </h4>
              <h4 className="text-sm text-zinc-500">Next React Tailwind CSS</h4>
            </div>
            <div className="bg-red-400 pt-12 lg:ps-2 flex justify-center w-full">
              <Image
                src={linguaFrame}
                width={400}
                height={500}
                alt="Frame SmartSell web"
        ...
        <Link
          target="_blank"
          href="https://landing-page-ea.vercel.app"
          rel="noopener noreferrer"
        >
          <motion.div
            whileInView={{ opacity: 1 }}
          ...
          >
            <div className="flex flex-col justify-center lg:w-3/5 p-5 ">
              ...
              <h4 className="text-sm text-zinc-500">
                TypeScript React Bootstrap Framer Motion
              </h4>
            </div>
        ...
        <Link
          target="_blank"
          href="https://smart-sell-frontend.vercel.app/report"
          rel="noopener noreferrer"
        >
          <motion.div
            whileInView={{ opacity: 1 }}
          ...
          >
            <div className="flex flex-col justify-center lg:w-3/5 p-5 ">
              ...
              <h4 className="text-sm text-zinc-500">
                Next.js Django PostgreSQL Tailwind CSS
              </h4>
            </div>
        ...
        <Link
          target="_blank"
          href="https://antistampa.netlify.app/"
          rel="noopener noreferrer"
        >
          <motion.div
            whileInView={{ opacity: 1 }}
        ...
        <Link
          target="_blank"
          href="https://emilianoaloi.github.io/ShowBiz/index.html"
          rel="noopener noreferrer"
        >
          <motion.div
            whileInView={{ opacity: 1 }}
        ...
        <Link
          target="_blank"
          href="https://phonefix.netlify.app/"
          rel="noopener noreferrer"
        >
          <motion.div
            whileInView={{ opacity: 1 }}
