      ...
      <header className="fixed w-full px-4 py-6 lg:px-10 md:shadow-md z-20 flex justify-center flex-wrap shadow-lg  transition duration-500 ease-in-out backdrop-filter backdrop-blur-md ">
        <nav className=" flex w-full justify-between items-center ">
          <Link href="/" className="flex gap-5 w-60">
            <div className="ps-2">
              <h2 className={`font-semibold ${museoModerno.className}`}>
                Emiliano Aloi
              </h2>
          ...
          <div className="hidden lg:flex  ">
            <ul className="flex gap-6 font-semibold ">
              <li>
                <Link href="#experience" className="hover:text-zinc-500">
                  Experiencia
                </Link>
              </li>
              <li>
                <Link href="#projects" className="hover:text-zinc-500">
                  Proyectos
                </Link>
              </li>
              <li>
        ...
        {isOpen ? (
          <ul className="lg:hidden flex flex-col gap-8 font-semibold text-center pt-6">
            <li>
              <Link
                href="/"
