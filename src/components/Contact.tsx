      ...
      >
        <div className="flex flex-col gap-1 mb-14">
          ...
          <p className="text-md text-zinc-500">
            Completá el siguiente formulario y te responderé dentro de las
            próximas 24 horas.
          </p>
        </div>
        <form
          ref={formDesktop}
          onSubmit={sendEmailDesktop}
          className="grid grid-flow-row-dense grid-cols-5 grid-rows-13 gap-20"
        >
          {/* Name */}
          ...
          <div className="flex flex-col col-span-2 row-span-2 gap-1">
            ...
            <label htmlFor="message" className="font-semibold text-xl">
              ¿Me contas sobre tu proyecto / producto / empresa en pocas
              palabras?
            </label>
            <p className="label-required font-semibold text-xs">REQUIRED</p>
          </div>
          ...
          <button className="form-button col-span-5 justify-self-end font-extrabold px-6 py-4 rounded-full">
            Enviar Mensaje
          </button>
        </form>
      </motion.section>
        ...
        >
          ...
          <div className="flex w-full flex-col gap-1 mb-2">
            ...
            <label htmlFor="message" className="font-semibold text-md">
              ¿Me contas sobre tu proyecto / producto / empresa ?
            </label>
            <p className="label-required font-semibold text-xs">REQUIRED</p>
          </div>
          <div className="">
            <textarea
              ...
              rows={8}
              name="user_message"
              className="w-full p-4 text-xs"
              placeholder="Escribe tu consulta"
            />
          </div>

          <div className="mt-10 text-end">
            <button className="form-button font-extrabold text-sm px-6 py-3 rounded-full ">
              Enviar Mensaje
            </button>
          </div>
        </form>
